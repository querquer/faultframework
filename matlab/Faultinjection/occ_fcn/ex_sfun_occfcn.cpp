/*
 *   ex_sfun_occfcn.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        double y1 = occ_fcn(single u1, single u2)
 *
 *   Simulink version           : 8.3 (R2014a) 27-Dec-2013
 *   C++ source code generated on : 04-Dec-2014 19:47:09
 ...
 */
#define S_FUNCTION_NAME                ex_sfun_occfcn
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "occ_fcn", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ex_sfun_occfcn_wrapper_output", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));
    }
  }
