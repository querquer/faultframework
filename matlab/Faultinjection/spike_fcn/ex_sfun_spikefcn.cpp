/*
 *   ex_sfun_spikefcn.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        double y1 = spike_fcn(single u1, single u2, double u3, double u4)
 *
 *   Simulink version           : 8.3 (R2014a) 27-Dec-2013
 *   C++ source code generated on : 11-Dec-2014 20:09:38
 ...
 */
#define S_FUNCTION_NAME                ex_sfun_spikefcn
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "spike_fcn", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ex_sfun_spikefcn_wrapper_output", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));
    }
  }
