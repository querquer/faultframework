/*
 *   ex_sfun_parsfcn.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        double y1 = pars_fcn(double u1, double u2, double u3, double u4, single u5)
 *
 *   Simulink version           : 8.3 (R2014a) 27-Dec-2013
 *   C++ source code generated on : 04-Dec-2014 19:33:43
...
/*
   ...
   def.OutputFcnSpec = 'double y1 = pars_fcn(double u1, double u2, double u3, double u4, single u5)';
 ...
 */
#define S_FUNCTION_NAME                ex_sfun_parsfcn
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "pars_fcn", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ex_sfun_parsfcn_wrapper_output", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));
    }
  }
