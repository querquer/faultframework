/*
 *   ex_sfun_schedulefcn.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = schedule_fcn(double u1, double u2, single u3, single u4)
 *
 *   Simulink version           : 8.3 (R2014a) 27-Dec-2013
 *   C++ source code generated on : 04-Dec-2014 19:50:41
 ...
 */
#define S_FUNCTION_NAME                ex_sfun_schedulefcn
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "schedule_fcn", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ex_sfun_schedulefcn_wrapper_output", MDL_INFO_ID_RESERVED,
                   0, 0, ssGetPath(S));
    }
  }
