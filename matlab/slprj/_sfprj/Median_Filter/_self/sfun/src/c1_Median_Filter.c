...
static const char * c1_debug_family_names[8] = { "i", "nargin", "nargout",
  "data_in", "old_vector", "order", "new_vector", "data_out" };
...
static void sf_gateway_c1_Median_Filter(SFc1_Median_FilterInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_Median_Filter(SFc1_Median_FilterInstanceStruct
  *chartInstance);
...
static void c1_eml_sort_idx(SFc1_Median_FilterInstanceStruct *chartInstance,
  real_T c1_x[100], int32_T c1_idx[100]);
static void c1_check_forloop_overflow_error(SFc1_Median_FilterInstanceStruct
  *chartInstance, boolean_T c1_overflow);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn(SFc1_Median_FilterInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_f_emlrt_marshallIn(SFc1_Median_FilterInstanceStruct
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_data_out = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c1_is_active_c1_Median_Filter = c1_f_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  c1_old_vector = (real_T (*)[100])ssGetInputPortSignal(chartInstance->S, 1);
  c1_new_vector = (real_T (*)[100])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_data_in = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c1_data_in, 0U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Median_Filter(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Median_FilterMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  for (c1_i2 = 0; c1_i2 < 100; c1_i2++) {
    _SFD_DATA_RANGE_CHECK((*c1_new_vector)[c1_i2], 1U);
  }

  for (c1_i3 = 0; c1_i3 < 100; c1_i3++) {
    _SFD_DATA_RANGE_CHECK((*c1_old_vector)[c1_i3], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*c1_order, 3U);
  _SFD_DATA_RANGE_CHECK(*c1_data_out, 4U);
}
  ...
  *chartInstance)
{
  ...
  c1_b_order = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  ...
  c1_b_hoistedGlobal = *c1_b_order;
  c1_data_in = c1_hoistedGlobal;
  for (c1_i4 = 0; c1_i4 < 100; c1_i4++) {
    c1_old_vector[c1_i4] = (*c1_b_old_vector)[c1_i4];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 2U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_data_in, 3U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_old_vector, 4U, c1_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_order, 5U, c1_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_new_vector, 6U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_data_out, 7U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c1_i5 = 0; c1_i5 < 100; c1_i5++) {
    c1_new_vector[c1_i5] = 0.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 10);
  c1_d0 = c1_order - 1.0;
  c1_i6 = (int32_T)c1_d0;
  _SFD_FOR_LOOP_VECTOR_CHECK(1.0, 1.0, c1_d0, mxDOUBLE_CLASS, c1_i6);
  c1_i = 1.0;
  c1_b_i = 0;
  while (c1_b_i <= c1_i6 - 1) {
    c1_i = 1.0 + (real_T)c1_b_i;
    CV_EML_FOR(0, 1, 0, 1);
    _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 11);
    c1_new_vector[_SFD_EML_ARRAY_BOUNDS_CHECK("new_vector", (int32_T)
      _SFD_INTEGER_CHECK("i", c1_i), 1, 100, 1, 0) - 1] =
      c1_old_vector[_SFD_EML_ARRAY_BOUNDS_CHECK("old_vector", (int32_T)
      _SFD_INTEGER_CHECK("i+1", c1_i + 1.0), 1, 100, 1, 0) - 1];
    c1_b_i++;
  ...
  for (c1_i7 = 0; c1_i7 < 100; c1_i7++) {
    c1_x[c1_i7] = c1_new_vector[c1_i7];
  }

  for (c1_i8 = 0; c1_i8 < 100; c1_i8++) {
    c1_b_x[c1_i8] = c1_x[c1_i8];
  }

  c1_eml_sort_idx(chartInstance, c1_b_x, c1_idx);
  c1_c_x = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c1_idx[99]), 1, 100, 1, 0) - 1];
  c1_b = muDoubleScalarIsNaN(c1_c_x);
  if (c1_b) {
    c1_data_out = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c1_idx[99]), 1, 100, 1, 0) - 1];
  } else {
    c1_a = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c1_idx[49]), 1, 100, 1, 0) - 1];
    c1_b_b = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c1_idx[50]), 1, 100, 1, 0) - 1];
    guard1 = false;
    guard2 = false;
    guard3 = false;
    if (c1_a < 0.0) {
  ...
  for (c1_i9 = 0; c1_i9 < 100; c1_i9++) {
    (*c1_b_new_vector)[c1_i9] = c1_new_vector[c1_i9];
  }
  ...
  *c1_inData)
{
  ...
  for (c1_i10 = 0; c1_i10 < 100; c1_i10++) {
    c1_b_inData[c1_i10] = (*(real_T (*)[100])c1_inData)[c1_i10];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i13 = 0; c1_i13 < 100; c1_i13++) {
    (*(real_T (*)[100])c1_outData)[c1_i13] = c1_y[c1_i13];
  }
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_sort_le.m!eml_sort_ascending_le"),
                  "context", "context", 32);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("isnan"), "name", "name", 32);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 32);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/median.m!vectormedian"),
                  "context", "context", 37);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("isnan"), "name", "name", 37);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 37);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/median.m!meanof"),
                  "context", "context", 38);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("isinf"), "name", "name", 38);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  real_T c1_x[100], int32_T c1_idx[100])
{
  ...
  for (c1_k = 1; c1_k < 101; c1_k++) {
    c1_b_k = c1_k;
    c1_idx[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c1_b_k), 1, 100, 1, 0) - 1] = c1_b_k;
  }

  for (c1_c_k = 1; c1_c_k < 100; c1_c_k += 2) {
    c1_b_k = c1_c_k;
    c1_a = c1_b_k;
    c1_b_a = c1_a;
    c1_c = c1_b_a;
    c1_irow1 = c1_b_k;
    c1_irow2 = c1_c + 1;
    c1_c_a = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c1_irow1), 1, 100, 1, 0) - 1];
    c1_b = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c1_irow2), 1, 100, 1, 0) - 1];
    c1_d_a = c1_c_a;
    c1_b_b = c1_b;
    c1_p = (c1_d_a <= c1_b_b);
    guard2 = false;
    ...
    if (c1_b_p) {
      ...
      c1_b_c = c1_f_a;
      c1_idx[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        (real_T)c1_b_k), 1, 100, 1, 0) - 1] = c1_b_c + 1;
      c1_g_a = c1_b_k;
      c1_h_a = c1_g_a;
      c1_c_c = c1_h_a;
      c1_idx[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
        (real_T)(c1_c_c + 1)), 1, 100, 1, 0) - 1] = c1_b_k;
    }
  }
  ...
  while (c1_i < 100) {
    ...
    c1_d_b = c1_i;
    c1_e_b = c1_d_b + 1;
    for (c1_pEnd = c1_e_b; c1_pEnd < 101; c1_pEnd = c1_kb_a + c1_r_b) {
      c1_c_p = c1_j;
      c1_q = c1_pEnd;
      c1_k_a = c1_j;
      c1_f_b = c1_i2;
      ...
      c1_n_a = c1_m_a;
      c1_i_b = c1_h_b;
      c1_kEnd = c1_n_a - c1_i_b;
      while (c1_b_k <= c1_kEnd) {
        c1_b_irow1 = c1_idx[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c1_c_p), 1, 100, 1, 0) - 1];
        c1_b_irow2 = c1_idx[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c1_q), 1, 100, 1, 0) - 1];
        c1_o_a = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c1_b_irow1), 1, 100, 1, 0) - 1];
        c1_j_b = c1_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
          _SFD_INTEGER_CHECK("", (real_T)c1_b_irow2), 1, 100, 1, 0) - 1];
        c1_p_a = c1_o_a;
        c1_k_b = c1_j_b;
        c1_d_p = (c1_p_a <= c1_k_b);
        guard1 = false;
        if (c1_d_p) {
          guard1 = true;
        } else {
          c1_c_x = c1_j_b;
          c1_l_b = muDoubleScalarIsNaN(c1_c_x);
          if (c1_l_b) {
            guard1 = true;
          } else {
            c1_b1 = false;
        ...
        c1_e_p = c1_b1;
        if (c1_e_p) {
          c1_idx0[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_b_k), 1, 100, 1, 0) - 1] =
            c1_idx[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
            "", (real_T)c1_c_p), 1, 100, 1, 0) - 1];
          c1_q_a = c1_c_p;
          c1_r_a = c1_q_a + 1;
          c1_c_p = c1_r_a;
          if (c1_c_p == c1_pEnd) {
            while (c1_q < c1_qEnd) {
              ...
              c1_t_a = c1_s_a + 1;
              c1_b_k = c1_t_a;
              c1_idx0[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
                _SFD_INTEGER_CHECK("", (real_T)c1_b_k), 1, 100, 1, 0) - 1] =
                c1_idx[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
                _SFD_INTEGER_CHECK("", (real_T)c1_q), 1, 100, 1, 0) - 1];
              c1_u_a = c1_q;
              c1_v_a = c1_u_a + 1;
              c1_q = c1_v_a;
      ...
      for (c1_d_k = 1; c1_d_k <= c1_b_kEnd; c1_d_k++) {
        ...
        c1_ib_a = c1_hb_a;
        c1_p_b = c1_o_b;
        c1_d_c = c1_ib_a + c1_p_b;
        c1_idx[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c1_d_c), 1, 100, 1, 0) - 1] =
          c1_idx0[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
          (real_T)c1_b_k), 1, 100, 1, 0) - 1];
      }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(929207823U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(844435725U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3396956712U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2206428120U);
}
...
mxArray *sf_c1_Median_Filter_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("vYrlPYCdU0ji01oNiLbJfG");
...
static void mdlSetWorkWidths_c1_Median_Filter(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3413776947U));
  ssSetChecksum1(S,(2968085984U));
  ssSetChecksum2(S,(816000881U));
  ssSetChecksum3(S,(4061046049U));
