...
static void initialize_c1_Median_Filter1(SFc1_Median_Filter1InstanceStruct
  *chartInstance);
static void initialize_params_c1_Median_Filter1
  (SFc1_Median_Filter1InstanceStruct *chartInstance);
static void enable_c1_Median_Filter1(SFc1_Median_Filter1InstanceStruct
  *chartInstance);
static void disable_c1_Median_Filter1(SFc1_Median_Filter1InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_Median_Filter1
  (SFc1_Median_Filter1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Median_Filter1
  (SFc1_Median_Filter1InstanceStruct *chartInstance);
static void set_sim_state_c1_Median_Filter1(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_Median_Filter1(SFc1_Median_Filter1InstanceStruct
  *chartInstance);
static void sf_gateway_c1_Median_Filter1(SFc1_Median_Filter1InstanceStruct
  *chartInstance);
static void initSimStructsc1_Median_Filter1(SFc1_Median_Filter1InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_data_out, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_new_vector, const char_T *c1_identifier,
  real_T c1_y[100]);
static void c1_d_emlrt_marshallIn(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[100]);
...
static void c1_e_emlrt_marshallIn(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
...
static real_T c1_median(SFc1_Median_Filter1InstanceStruct *chartInstance, real_T
  c1_x_data[], int32_T c1_x_sizes);
static void c1_eml_switch_helper(SFc1_Median_Filter1InstanceStruct
  *chartInstance);
static void c1_eml_sort_idx(SFc1_Median_Filter1InstanceStruct *chartInstance,
  real_T c1_x_data[], int32_T c1_x_sizes, int32_T c1_idx_data[], int32_T
  *c1_idx_sizes);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_g_emlrt_marshallIn(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_Median_Filter1, const char_T *
  c1_identifier);
static uint8_T c1_h_emlrt_marshallIn(SFc1_Median_Filter1InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_Median_Filter1InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Median_Filter1 = 0U;
}
  ...
  (SFc1_Median_Filter1InstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_Median_Filter1;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_data_out = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c1_is_active_c1_Median_Filter1 = c1_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_Median_Filter1");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Median_Filter1(chartInstance);
  ...
  *chartInstance)
{
  ...
  *c1_b_data_out = c1_data_out;
  ...
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Median_Filter1MachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Median_Filter1InstanceStruct *chartInstance;
  chartInstance = (SFc1_Median_Filter1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_Median_Filter1_get_eml_resolved_functions_info(void)
{
  ...
  c1_identifier)
{
  ...
  c1_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_Median_Filter1), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Median_Filter1);
  return c1_y;
}
...
void sf_c1_Median_Filter1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Median_Filter1_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_Median_Filter1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Median_Filter1_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_Median_Filter1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[9],T\"data_out\",},{M[1],M[5],T\"new_vector\",},{M[8],M[0],T\"is_active_c1_Median_Filter1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Median_Filter1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_Median_Filter1InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_Median_Filter1MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_Median_Filter1MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Median_Filter1MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_Median_Filter1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Median_Filter1InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Median_Filter1((SFc1_Median_Filter1InstanceStruct*)
    chartInstanceVar);
  initialize_c1_Median_Filter1((SFc1_Median_Filter1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_Median_Filter1(void *chartInstanceVar)
{
  enable_c1_Median_Filter1((SFc1_Median_Filter1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Median_Filter1(void *chartInstanceVar)
{
  disable_c1_Median_Filter1((SFc1_Median_Filter1InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_Median_Filter1(void *chartInstanceVar)
{
  sf_gateway_c1_Median_Filter1((SFc1_Median_Filter1InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Median_Filter1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Median_Filter1
    ((SFc1_Median_Filter1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Median_Filter1();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Median_Filter1(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Median_Filter1();/* state var info */
  ...
  set_sim_state_c1_Median_Filter1((SFc1_Median_Filter1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Median_Filter1(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Median_Filter1(S);
}

static void sf_opaque_set_sim_state_c1_Median_Filter1(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_Median_Filter1(S, st);
}

static void sf_opaque_terminate_c1_Median_Filter1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Median_Filter1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Median_Filter1_optimization_info();
    }

    finalize_c1_Median_Filter1((SFc1_Median_Filter1InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_Median_Filter1((SFc1_Median_Filter1InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Median_Filter1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Median_Filter1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Median_Filter1_optimization_info();
...
static void mdlRTW_c1_Median_Filter1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Median_Filter1(SimStruct *S)
{
  SFc1_Median_Filter1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Median_Filter1InstanceStruct *)utMalloc(sizeof
    (SFc1_Median_Filter1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Median_Filter1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Median_Filter1;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Median_Filter1;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Median_Filter1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Median_Filter1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_Median_Filter1;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Median_Filter1;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Median_Filter1;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Median_Filter1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Median_Filter1;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Median_Filter1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_Median_Filter1;
...
void c1_Median_Filter1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Median_Filter1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Median_Filter1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Median_Filter1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Median_Filter1_method_dispatcher.\n"
